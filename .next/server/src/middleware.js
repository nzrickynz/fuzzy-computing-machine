...
async function middleware(request) {
    ...
    const supabase = createServerClient("https://xuuufzuzubnvvsbgvemc.supabase.co", process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
        cookies: {
            get (name) {
